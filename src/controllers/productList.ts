export const dailyProducts = [
    ...
    },
    {
      ...
      brand: "Other",
      badge: false,
      des: {en:"R1 Charged Creatine’s refreshing fruit flavors are built to support an enhanced workout with hydration, energy, and greater training capacity.",},
      cat: "",
      pdf: "",
      extraInfo: "GMO-free",
      price: 25,
    ...
    },
    {
      ...
      brand: "Other",
      badge: false,
      des: {en:"With 10 grams total Essential Amino Acids (EAAs), including 7.2 grams of Branched Chain Amino Acids (BCAAs), ALL9 AminoTM is the ultimate goal-crushing muscle recovery formula. Experience the unrivaled and potent Essential Amino Acid formula in ALL9 that supports speedy muscle recovery and the Muscle Protein Synthesis process that is necessary for muscle growth.",},
      cat: "",
      pdf: "",
      extraInfo: "GMO-free",
      price: 60,
    ...
    },
    {
      ...
      brand: "Other",
      badge: false,
      des: {en:"The Mass Power Sport Complex offers a comprehensive solution to enhance muscle development and support weight gain. With its protein-rich components and convenient protein bars, it provides a convenient and effective way to fuel your body for optimal performance and size gains.",},
      cat: "Proteins",
      pdf: "",
      extraInfo: "GMO-free",
      price: 150,
    ...
    },
    {
      ...
      brand: "Other",
      badge: false,
      des: {en:"ISO100 is simply muscle-building fuel. If your goal is gaining muscle size and strength, then ISO100 is your perfect workout partner. Loaded with muscle-building amino acids, ISO100 can support even the most serious resistance-training programs."},
      cat: "",
      pdf: "",
      extraInfo: "GMO-free",
      price: 80.5,
    ...
    {
      _id: 15,
      name: "Nature Plus Acerola-C 500mg",
      ficheTech: [],
      brand: "Nature plus",
      badge: false,
      des: {
    ...
    {
      _id: 16,
      name: "Nature Plus Cal/Mag/Vit D3",
      ficheTech: [],
      brand: "Nature plus",
      badge: false,
      des: {
    ...
    {
      _id: 17,
      name: "Nature's Plus Source of Life Garden Vitamin K2",
      ficheTech: [],
      brand: "Nature plus",
      badge: false,
      des: {
